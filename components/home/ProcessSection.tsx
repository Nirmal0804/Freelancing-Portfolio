...
export const ProcessSection: React.FC = () => {
  return (
    <section className="w-full border-t border-b border-[#E5E2E1] grid grid-cols-1 md:grid-cols-12 bg-surface-container-lowest" id="process">
      ...
      <div className="md:col-span-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 divide-y sm:divide-y-0 sm:divide-x divide-[#E5E2E1]">
        {STEPS.map((step, idx) => (
          <div
            key={step.number}
            className={`p-6 sm:p-8 hover:bg-surface-container-low transition-colors ${
              idx % 2 === 0 ? "border-r sm:border-r-0 border-[#E5E2E1]" : ""
            } ${idx < 4 ? "border-b lg:border-b-0 border-[#E5E2E1]" : ""}`}
          >
