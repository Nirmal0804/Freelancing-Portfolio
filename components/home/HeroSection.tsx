...
export const HeroSection: React.FC = () => {
  return (
    <section
      className="relative w-full border-b border-[#cdc5c2] bg-background min-h-[65vh] sm:min-h-[72vh] lg:min-h-[78vh] flex items-center overflow-hidden px-6 sm:px-10 md:px-14 lg:px-20 py-12 sm:py-16 lg:py-20"
      aria-label="Hero Section"
    >
      <div className="w-full max-w-[1360px] mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 lg:gap-16">
        {/* Left Side: Hey, there text */}
        ...
        <div className="shrink-0 self-center lg:self-auto flex justify-center items-center">
